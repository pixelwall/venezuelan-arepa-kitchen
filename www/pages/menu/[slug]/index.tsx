...
const getLayoutProps: GetLayoutProps<{ menu?: Product }> = ({ menu }) => ({
  title: menu.title,
  image: menu.thumbnails[0].responsiveImage.src,
})

const MenuSlug = (data: MenuSlugProps) => {
  const { menu } = data
  return (
...
MenuSlug.getLayoutProps = getLayoutProps
